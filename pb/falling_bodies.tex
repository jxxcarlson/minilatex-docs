\section{On Falling Bodies: Aristotle and Galileo}

Consider the question

\begin{indent}
\italic{Do heavy bodies fall faster than light ones?}
\end{indent}
...
\begin{indent}
\strong{Salviati}.  If then we take two bodies whose natural speeds are different, it is clear that on uniting the two, the more rapid one will be partly retarded by the slower, and the slower will be somewhat hastened by the swifter. Do you not agree with 
me in this opinion?
\end{indent}

\begin{indent}
\strong{Simplicio}. You are unquestionably right.
\end{indent}

\begin{indent}
\strong{Salviati} But if this is true, and if a large stone moves with a speed of, say, eight while a smaller moves with a speed of four, then when they are united, the system will move with a speed less than eight; but the two stones when tied together make a stone larger than that which before moved with a speed of eight. Hence the heavier body moves with less speed than the lighter; an effect which is contrary to your supposition. Thus you see how, from your assumption that the heavier body moves more rapidly than the lighter one, I infer that the heavier body moves more slowly.[11]
\end{indent}
...
Galileo's principle of equal times raises a new, deeper question: \italic{Why?}
