...
\ccode{b.}. Instead of computing individual cases iike \ccode{from(to 5)} for individual numbers, our goal is to apply this computation to a whole list of numbers.  The first task, then, is to define the type of lists:
